...
myPolynomial::myPolynomial(int c, unsigned e) : no_term(1) { po[0].coeff = c, po[0].exp = e; }
...
bool myPolynomial::operator!=(const myPolynomial &poly) const { return !(*this == poly); }
myPolynomial &myPolynomial::operator+=(const myPolynomial &poly) { return *this = *this + poly; }
myPolynomial &myPolynomial::operator-=(const myPolynomial &poly) { return *this = *this - poly; }
myPolynomial &myPolynomial::operator*=(const myPolynomial &poly) { return *this = *this * poly; }
myPolynomial &myPolynomial::operator*=(int k) { return *this = *this * myPolynomial(k, (unsigned)0); }
...
myPolynomial myPolynomial::operator*(int k) const { return *this * myPolynomial(k, (unsigned)0); }
...
myPolynomial myPolynomial::operator-(const myPolynomial &poly) const { return *this + (-poly); }
...
unsigned myPolynomial::getNumTerms() const { return no_term; } // number of terms in the polynomial
...
myPolynomial operator*(int k, const myPolynomial &poly) { return myPolynomial(k, (unsigned)0) * poly; }
